...
{   
    ...
    floatSpinDelegate=new TFloatSpinDelegate;
    ui->tableView->setItemDelegateForColumn(0,floatSpinDelegate);

    comboBoxDelegate=new QComboBoxDelegate;
    QStringList itemList;
    itemList<<"优"<<"良"<<"中";
    comboBoxDelegate->setItem(itemList,false);
