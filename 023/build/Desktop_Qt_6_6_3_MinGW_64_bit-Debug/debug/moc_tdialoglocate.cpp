...
constexpr auto qt_meta_stringdata_CLASSTDialogLocateENDCLASS = QtMocHelpers::stringData(
    "TDialogLocate",
    "cellTextChanged",
    "",
    "row",
    ...
    "rowNum",
    "colNum",
    "on_pushButton_setWords_clicked"
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTDialogLocateENDCLASS_t qt_meta_stringdata_CLASSTDialogLocateENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 15),  // "cellTextChanged"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 3),  // "row"
        QT_MOC_LITERAL(35, 6),  // "column"
        QT_MOC_LITERAL(42, 8),  // "QString&"
        QT_MOC_LITERAL(51, 4),  // "text"
        QT_MOC_LITERAL(56, 18),  // "changeActionEnable"
        QT_MOC_LITERAL(75, 6),  // "enable"
        QT_MOC_LITERAL(82, 15),  // "setSpinBoxValue"
        QT_MOC_LITERAL(98, 6),  // "rowNum"
        QT_MOC_LITERAL(105, 6),  // "colNum"
        QT_MOC_LITERAL(112, 30)   // "on_pushButton_setWords_clicked"
    },
    "TDialogLocate",
    "cellTextChanged",
    "",
...
Q_CONSTINIT const QMetaObject TDialogLocate::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTDialogLocateENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_pushButton_setWords_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void TDialogLocate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->cellTextChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[3]))); break;
        case 1: _t->changeActionEnable((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->setSpinBoxValue((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 3: _t->on_pushButton_setWords_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TDialogLocate::cellTextChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TDialogLocate::cellTextChanged(int _t1, int _t2, QString & _t3)
{
